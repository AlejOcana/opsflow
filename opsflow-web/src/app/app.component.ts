...
@Component({
  ...
  styles: [`
    ...
    .notif-bell { width: 38px !important; height: 38px !important; border-radius: 12px !important; background: #f8fafc; border: 1px solid rgba(15,23,42,0.06); flex-shrink: 0; transition: background 0.16s ease, border-color 0.16s ease, transform 0.14s ease, box-shadow 0.16s ease; --mat-icon-button-state-layer-size: 38px; position: relative; }
